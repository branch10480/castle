...
:root {
  ...
  --sans:  system-ui, -apple-system, "Hiragino Sans", "Hiragino Kaku Gothic ProN",
           "YuGothic", "Yu Gothic", /* …Win/Linux 系 fallback… */ sans-serif;
  --mono:  "JetBrainsMono Nerd Font Mono", "JetBrainsMono Nerd Font", "JetBrains Mono",
           ui-monospace, "SF Mono", /* …Menlo / Monaco / Consolas… */ monospace;
}
```

> 上記は概形。完全な fallback リスト (Segoe UI / Roboto / Helvetica / Arial / Menlo / Monaco / Consolas を含む) は `claude/skills/html-artifact/design-system.html:30-37` を参照。
