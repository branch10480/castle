...
# fi
if command -v cmux &>/dev/null; then
  alias cc='cmux claude-teams --dangerously-skip-permissions --effort high --model claude-opus-4-6'
  alias ccc='cmux claude-teams --continue --effort high --model claude-opus-4-6'
  alias cch='cmux claude-teams --dangerously-skip-permissions --model haiku'
  alias ccs='cmux claude-teams --dangerously-skip-permissions --effort high --model claude-sonnet-4-6'
  alias ccp='cmux claude-teams --dangerously-skip-permissions --effort high --print --model claude-opus-4-6'
  alias ccsp='cmux claude-teams --dangerously-skip-permissions --effort high --print --model claude-sonnet-4-6'
  alias cchp='cmux claude-teams --dangerously-skip-permissions --print --model haiku --bare'
else
  alias cc='claude --dangerously-skip-permissions --effort high --model claude-opus-4-6'
  alias ccc='claude --dangerously-skip-permissions --continue --effort high --model claude-opus-4-6'
  alias cch='claude --dangerously-skip-permissions --model haiku'
  alias ccs='claude --dangerously-skip-permissions --effort high --model claude-sonnet-4-6'
  alias ccp='claude --dangerously-skip-permissions --effort high --print --model claude-opus-4-6'
  alias ccsp='claude --dangerously-skip-permissions --effort high --print --model claude-sonnet-4-6'
  alias cchp='claude --dangerously-skip-permissions --print --model haiku --bare'
fi
alias t='tig status'
