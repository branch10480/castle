...
# fi
if command -v cmux &>/dev/null; then
  alias cc='cmux claude-teams --dangerously-skip-permissions --model claude-opus-4-6[1m]'
  alias ccc='cmux claude-teams --continue --model claude-opus-4-6[1m]'
  alias cch='cmux claude-teams --dangerously-skip-permissions --model haiku'
  alias ccs='cmux claude-teams --dangerously-skip-permissions --model claude-sonnet-4-6[1m]'
  alias ccp='cmux claude-teams --dangerously-skip-permissions --print --model claude-opus-4-6[1m]'
  alias ccsp='cmux claude-teams --dangerously-skip-permissions --print --model claude-sonnet-4-6[1m]'
  alias cchp='cmux claude-teams --dangerously-skip-permissions --print --model haiku --bare'
else
  alias cc='claude --dangerously-skip-permissions --model claude-opus-4-6[1m]'
  alias ccc='claude --dangerously-skip-permissions --continue --model claude-opus-4-6[1m]'
  alias cch='claude --dangerously-skip-permissions --model haiku'
  alias ccs='claude --dangerously-skip-permissions --model claude-sonnet-4-6[1m]'
  alias ccp='claude --dangerously-skip-permissions --print --model claude-opus-4-6[1m]'
  alias ccsp='claude --dangerously-skip-permissions --print --model claude-sonnet-4-6[1m]'
  alias cchp='claude --dangerously-skip-permissions --print --model haiku --bare'
fi
alias t='tig status'
